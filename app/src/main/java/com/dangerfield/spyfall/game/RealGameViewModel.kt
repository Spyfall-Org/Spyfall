...
class RealGameViewModel(private val repository: GameRepository) : ViewModel() {

    val liveGame = repository.currentSession?.liveGame
    val gameExists = repository.currentSession?.gameExists
    ...
    fun hasStartedGame() = repository.currentSession?.hasStartedGame() == true
