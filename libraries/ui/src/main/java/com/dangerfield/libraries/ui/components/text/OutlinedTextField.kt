...
private val outlinedTextFieldColors
    ...
    get() = OutlinedTextFieldDefaults.colors(
        focusedContainerColor = OddOneOutTheme.colors.background.color,
        unfocusedContainerColor = OddOneOutTheme.colors.background.color,
        disabledContainerColor = OddOneOutTheme.colors.background.color,
        focusedBorderColor = OddOneOutTheme.colors.border.color,
        unfocusedBorderColor = OddOneOutTheme.colors.border.color,
    )
